...
Block.createBlock("fluidConduitEx", [
  { name: "Fluid Conduit Extractor", texture: [["liquidConduitExtract", 0]], inCreative: true }
]);
...
PAPI.registerPipe(BlockID.fluidConduit, 200, 0.35, ["liquid-pipe"], true, -1, true, 50)

PAPI.registerPipe(BlockID.fluidConduitEx, 50, 0.35, PAPI.groups, true)
